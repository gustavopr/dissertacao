...
plot(data_(1:size(IBCBR_ciclo,1)),IBCBR_ciclo,'-o','Color','k','MarkerFaceColor','k','MarkerSize',3)
hold on
...
% Extraindo componentes cíclicos de candidatas ao Leading Indicator]
