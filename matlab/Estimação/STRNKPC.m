...
% *************************************************************************
% 3. TESTES DE NÃO LINEARIDADE
% *************************************************************************
% funcao LinTest.m
% ------------------------

% PRIMEIRO TESTE: VARIÁVEIS SEM LAG - TESTE CONTEMPORANEO
...
disp('Lineariy Test - desvios da inflação [F f isH0 pvalue]:')
[F  f  isH0  pvalue]
...
figure('Name','Autocorrelação dos resíduos')
autocorr(ehat1)

figure('Name','Função logística')
subplot(221), plot(q(:,1),fX1,'.k'), grid, title('Impacto do hiato do produto na função logística'),
subplot(222), plot(ym,fX1,'.k'), grid, title('Função logística referente ao hiato do produto no tempo')
subplot(223), plot(q(:,2),fX2,'.k'), grid, title('Impacto dos desvios da inflação na função logística'),
subplot(224), plot(ym,fX2,'.k'), grid, title('Função logística referente aos desvios da inflação no tempo')
